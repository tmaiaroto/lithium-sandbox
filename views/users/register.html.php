<div class="container_16 no-bg">
	<div class="grid_10">
		<div class="box-bg">
			...
			<?=$this->form->create($document, array('id' => 'registration-form', 'action' => 'register', 'onSubmit' => 'return submitCheck();')); ?>
				<?=$this->security->requestToken(); ?>
						...
						<div class="input"><?=$this->form->field('email', array('label' => 'E-mail', 'id' => 'email_input', 'placeholder' => 'Will be your login'));?><div class="input_help_right">Please enter your e-mail address.</div></div>
